...
Module['ltbl'] = Module['ltbl'] || {};

Module['ltbl'].sendMessageToUnity = function(message)
{
    console.log("NEW sendMessageToUnity() message is: ",message)

    const messageJson = JSON.stringify(message, null, 2);
    Module.SendMessage('WebGLMessenger', 'ReceiveMessageFromJs', messageJson);
}
...
function __CalculateNodeResult(nodeJson) {
 nodeJson = UTF8ToString(nodeJson);
 var wn = window.webpackNumbers;
 var oc = wn.geometry.openCascade;
 console.log(`nodeCalculator: ` + wn.nodeCalculator.calculateNodeResult);
 let nodeResult = wn.nodeCalculator.calculateNodeResult(nodeJson);
 console.log(`## node result: `, nodeResult);
 var returnStr = nodeResult;
 var bufferSize = lengthBytesUTF8(returnStr) + 1;
 var buffer = _malloc(bufferSize);
 stringToUTF8(returnStr, buffer, bufferSize);
 return buffer;
...
function __Init(callId) {
 callId = UTF8ToString(callId);
 console.log("this inside library is: ", this);
 console.log("Module inside library is: ", Module);
 console.log("InitWebpackNumbers called...");
 var wn = window.webpackNumbers;
 var oc = wn.geometry.openCascade;
 wn.init().then(openCascade => {
  let message = {
   callId: callId,
   value: null,
   error: null
  };
  Module.ltbl.sendMessageToUnity(message);
 }).catch(error => {
  let message = {
   callId: callId,
   value: null,
...
function __MakeBottle(callId, width, height, thickness) {
 callId = UTF8ToString(callId);
 var wn = window.webpackNumbers;
 var oc = wn.geometry.openCascade;
 var bottle = wn.geometry.makeBottle(width, height, thickness);
 var facelist = wn.geometry.tessellate(bottle);
 var returnStr = JSON.stringify(facelist, null, 2);
 var bufferSize = lengthBytesUTF8(returnStr) + 1;
 var buffer = _malloc(bufferSize);
 stringToUTF8(returnStr, buffer, bufferSize);
 return buffer;
...
var asmLibraryArg = {
 ...
 "_CalculateNodeResult": __CalculateNodeResult,
 "_Init": __Init,
 "_MakeBottle": __MakeBottle,
 ...
 "invoke_fiiid": invoke_fiiid,
 "invoke_fiiidi": invoke_fiiidi,
 "invoke_fiiifi": invoke_fiiifi,
 "invoke_fiiii": invoke_fiiii,
 "invoke_fiiiii": invoke_fiiiii,
 "invoke_fiiij": invoke_fiiij,
 "invoke_fiiiji": invoke_fiiiji,
 "invoke_i": invoke_i,
 ...
 "invoke_viiiiffffff": invoke_viiiiffffff,
...
var dynCall_iiiffffff = Module["dynCall_iiiffffff"] = createExportWrapper("dynCall_iiiffffff");
...
var dynCall_fiiid = Module["dynCall_fiiid"] = createExportWrapper("dynCall_fiiid");

var dynCall_fiiij = Module["dynCall_fiiij"] = createExportWrapper("dynCall_fiiij");
...
var dynCall_fiiidi = Module["dynCall_fiiidi"] = createExportWrapper("dynCall_fiiidi");

var dynCall_viiiiji = Module["dynCall_viiiiji"] = createExportWrapper("dynCall_viiiiji");

var dynCall_fiiiji = Module["dynCall_fiiiji"] = createExportWrapper("dynCall_fiiiji");
...
var dynCall_viiiiffffff = Module["dynCall_viiiiffffff"] = createExportWrapper("dynCall_viiiiffffff");
...
var dynCall_viiiiiiffffiiiii = Module["dynCall_viiiiiiffffiiiii"] = createExportWrapper("dynCall_viiiiiiffffiiiii");

var dynCall_viiiiffiiiii = Module["dynCall_viiiiffiiiii"] = createExportWrapper("dynCall_viiiiffiiiii");

var dynCall_viiiiiiiiffffiiiii = Module["dynCall_viiiiiiiiffffiiiii"] = createExportWrapper("dynCall_viiiiiiiiffffiiiii");
...
function invoke_iiiffffff(index, a1, a2, a3, a4, a5, a6, a7, a8) {
 var sp = stackSave();
 try {
  return dynCall_iiiffffff(index, a1, a2, a3, a4, a5, a6, a7, a8);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0) throw e;
  _setThrew(1, 0);
...
function invoke_viiiiffffff(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) {
 var sp = stackSave();
 try {
  dynCall_viiiiffffff(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0) throw e;
  _setThrew(1, 0);
...
function invoke_fiiij(index, a1, a2, a3, a4, a5) {
 var sp = stackSave();
 try {
  return dynCall_fiiij(index, a1, a2, a3, a4, a5);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0) throw e;
  _setThrew(1, 0);
...
function invoke_fiiiji(index, a1, a2, a3, a4, a5, a6) {
 var sp = stackSave();
 try {
  return dynCall_fiiiji(index, a1, a2, a3, a4, a5, a6);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0) throw e;
  _setThrew(1, 0);
